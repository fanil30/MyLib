...
public class RegisterServlet extends CustomHttpServlet {
    ...
    protected void onGetParameterFinish(HashMap parameterMap) {
        ...
        if (TextUtil.isEmpty(phone, password)) {
            response = new com.wang.java_program.shopping_system.Response<>(com.wang.java_program.shopping_system.StateCode.PARAM_ERROR, "手机号或密码为空");
            return;
        }
        ...
        try {
            ...
            if (userDao.query(phone) != null) {
                response = new com.wang.java_program.shopping_system.Response<>(com.wang.java_program.shopping_system.StateCode.ERROR_NORMAL, "该手机号已注册");
            } else {
                ...
                userDao.insert(user);
                response = new com.wang.java_program.shopping_system.Response<>(com.wang.java_program.shopping_system.StateCode.OK, "注册成功");
            }
