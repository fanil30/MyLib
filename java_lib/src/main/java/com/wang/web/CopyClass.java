...
public class CopyClass {
    ...
    public static String buildClassDir = "C:\\IDE\\android-studio-project\\MyLib\\java_lib\\";
    public static String serverName = "shopping_system";

    public static void main(String[] args) throws Exception {
        String fromDir = buildClassDir + "build/classes/main/";
        String toDir = "C:/IDE/apache-tomcat-7.0.67/webapps/" + serverName + "/WEB-INF/";
        ...
        fromDir = "C:\\IDE\\android-studio-project\\MyLib\\java_lib\\build\\libs\\java_lib.jar";
