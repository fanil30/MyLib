...
public class UserDao extends CustomDao {
    ...
    public User query(String phone, String password) throws SQLException {
        ArrayList<User> userList = super.query(User.class, "phone", phone, false);
     ...
     * 根据用户id更新用户性别
     */
    public void updateSex(int userId, int sex) throws SQLException {
        super.update(User.class, userId, "sex", sex);
    }
