package com.wang.android_lib.view.helper;
 ...
 * http://blog.csdn.net/pengkv/article/details/50538121 RecyclerView的万能分割线
 * 使用方法：rvSign.addItemDecoration(new RecyclerViewDivider(this));
 */
